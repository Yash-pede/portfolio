...
const HeroTitle = () => {
  ...
  return (
    <section className="h-60 px-7 w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-start md:justify-center">
