...
const HeroTitle = () => {
  ...
  return (
    <div className="h-60 w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-start md:justify-center">
      ...
      <p className="text-2xl sm:text-3xl md:text-5xl md:text-center  font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 pb-8">
        {HeroTitleData.map(
          (data, index) =>
            data.route === pathname &&
