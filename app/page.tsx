...
export default function Home() {
  return (
    <div className="flex flex-col gap-36">
      <GithubContributions />
      <ScrollingText text="I'm an experienced full-stack developer with a passion for design and a knack for tinkering. Web development is my playground, where push boundaries and chase new horizons." />
      <About items={items} />
      <SkillsStagger />
    </div>
  );
